package com.qingaren.middleware.dynamic.thread.pool.sdk.config;

import com.qingaren.middleware.dynamic.thread.pool.sdk.domain.DynamicThreadPoolService;
...
import com.qingaren.middleware.dynamic.thread.pool.sdk.registry.redis.RedisRegistry;
import com.qingaren.middleware.dynamic.thread.pool.sdk.trigger.job.ThreadPoolDataReportJob;
import com.qingaren.middleware.dynamic.thread.pool.sdk.trigger.listener.ThreadPoolConfigAdjustListener;
...
public class DynamicThreadPoolAutoConfig {
    ...
    public RTopic threadPoolConfigAdjustListener(RedissonClient redissonClient, ThreadPoolConfigAdjustListener threadPoolConfigAdjustListener){
        RTopic rTopic = redissonClient.getTopic(RegistryEnumVO.DYNAMIC_THREAD_POOL_REDIS_TOPIC.getKey() + applicationName);
